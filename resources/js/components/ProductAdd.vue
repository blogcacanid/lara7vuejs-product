<template>
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header"><h3><i class="fas fa-plus-circle"></i>&nbsp;Add Product</h3></div>
                <div class="card-body">
                    ...
                    <form @submit.prevent="addRecord">
                        ...
                        <div class='form-group'>
                            ...
                            &nbsp;
                            &nbsp;
                            <button class="btn btn-success" title="Save Record"><i class="fas fa-save"></i>&nbsp;Save</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        methods: {
            addRecord(e){
                if (this.$data.product.product_name != null && this.$data.product.product_price != null) {
                    ...
                    let uri = 'http://localhost:8080/api/products';
                    axios
